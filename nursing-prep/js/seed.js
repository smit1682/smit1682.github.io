/* ═══════════════════════════════════════════════════════
   SEED — the paper the app ships with.
   Used as-is in demo mode, and offered as a starting
   sample. Replace or add papers from the Admin screen.
   ═══════════════════════════════════════════════════════ */

window.SEED_TESTS = [
  {
    id: 'seed-1',
    title: 'Sample Paper — Fundamentals of Nursing',
    duration_minutes: 60,
